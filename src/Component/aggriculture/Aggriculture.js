...
import '../StokeProduct/Stoke.scss'
import Mechine from './data';
            ...
            <div className="header_stoke">
                ...
                <div className="all_image_container">
                    ...
                    <div className="bigImage_container">
                        ...
                        <img src="https://pixboost.com/api/2/img/https://dev-admin.globaltradeplaza.com/public/storage/product_images/459/1625206700.png/resize?size=300&auth=MzA5ODU4ODUwMA__"
                        alt="" />
